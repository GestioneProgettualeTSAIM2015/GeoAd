...
public class DeleteImageAlertDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		builder.setPositiveButton(getResources().getString(R.string.delete_photo_dialog_yes), new DialogInterface.OnClickListener() {
		...
		builder.setNegativeButton(getResources().getString(R.string.delete_photo_dialog_no), null);
